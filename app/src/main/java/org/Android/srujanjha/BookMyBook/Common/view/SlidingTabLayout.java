...
package org.android.srujanjha.bookmybook.common.view;
...
*/
    ...
    protected TextView createDefaultTabView(Context context) {
        int TAB_VIEW_PADDING_DIPS = 20;
        int TAB_VIEW_TEXT_SIZE_SP = 14;
        ...
        int hpadding = (int) (TAB_VIEW_PADDING_DIPS * getResources().getDisplayMetrics().density);
        int vpadding = (int) (20 * getResources().getDisplayMetrics().density);
